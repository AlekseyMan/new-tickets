<div class="d-flex justify-content-center">
    ...
    <a href="/karateki" class="text-decoration-none"><button class="m-3 btn btn-secondary">Ученики</button></a>
    <a href="/teams" class="text-decoration-none"><button class="m-3 btn btn-secondary">Команды</button></a>
